\documentclass[a4paper,titlepage,twoside=true,bibliography=totoc]{scrreprt}
...
\input{chapters/GrundlagenStandDerTechnik}
...
\input{chapters/Schlussfolgerungen}

\input{chapters/Zusammenfassung}

\input{chapters/IdeenUndNotizen.tex}
