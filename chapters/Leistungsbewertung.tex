		...
		\subsection{Vergleich der Ergebnisse mit unterschiedliche Schwellwerten} 
			...
			\subsubsection{Ergebnisse zur Stadtebene}
				...
				\begin{table}[h]
					...
					\hline
					  & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Schwellwert\\ relativ\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Schwellwert\\ absolut\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Ergebnismenge\\ (Anteil)\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Median\\ Fehlerdist. \\ (m)\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Durchschn.\\ Fehlerdis. \\ (m)\end{tabular}} \\ \hline
			...
			\subsubsection{Ergebnisse zur Verwaltungseinheit erster und zweiter Ordnung, Land}
				...
				Vergleicht man die Plots in Abbildung \ref{img:recallAll} so weisen auch diese die gleiche Charakteristik auf. 
				...
				\centering
				  \begin{tabular}{@{}ccc@{}}
				   ...
				   \multicolumn{2}{c}{\includegraphics[width=.5\textwidth]{matlabPlot/coPrecision.eps}}
				       \\
				  \end{tabular}
				...
				\centering
				  \begin{tabular}{@{}ccc@{}}
				   ...
				   \multicolumn{2}{c}{\includegraphics[width=.8\textwidth]{matlabPlot/adm2RecallNEW.eps}} \\
				  \end{tabular}
