...
\chapter{Lösungsansatz} \label{chp:Loesungsansatz}
	...
	\section{Verfahren zum Einlernen der Georeferenz-Basis} \label{sec:VefrahrenZumEinlernen} 	
		...
		\subsection{Quantitative Betrachtung der Referenzwerte bezüglich der geografischen Position}
			...
			Die Referenzwerte die in den letzten Schritten erzeugt wurden, sollen nun einer quantitativen Betrachtung unterzogen werden.
			Dabei sollen die Vorkommen eines Referenzwertes an einer geografischen Position gezählt werden.
			Dieser Wert wird als absolute Häufigkeit bezeichnet.

			Im folgenden werden die Ergebnisse der vorhergehenden Schritte genutzt.
			Jedes N-Gramm und die Kombinationen aus N-Grammen und Zeitzonen wird als einzelner Wert betrachtet. 
			Diesen werden als geografische Koordinaten die Koordinaten desjenigen Tweets zugeordnet aus dem das N-Gramm erzeugt wurde.
			Zur Verdeutlichung ist in Tabelle \ref{tab:bspWerteAusEinemTweet} das Ergebnis der oben genannten Schritte an einem Beispiel dargestellt. 
				...
				\begin{tabular}{|l|l|l|}
				\hline
				\multicolumn{1}{|c|}{\textbf{Ursprung}} & \multicolumn{2}{l|}{\begin{tabular}[c]{@{}l@{}}Nutzer-Standortfeld:    love Los Angeles \\                Nutzer-Zeitzone:           Pacific-Time\\                geog. Koordinaten:       (33.78, 118.29)\end{tabular}} \\ \hline \hline
				                                        & \multicolumn{1}{c|}{\textbf{Referenzwert}}                                                                       & \multicolumn{1}{c|}{\textbf{geografische Koordinaten}}                          \\ \hline
				...
				5                                       & \textless Los+Angeles\textgreater\textless love\textgreater\textless \textit{Pacific+Time}\textgreater                                & (33.78, 118.29)                                                                               \\ \hline
				\textit{6}                              & \textless Los+Angeles\textgreater\textless \textit{Pacific+Time}\textgreater                                                         & \textit{(33.78, 118.29)}                                                                      \\ \hline
				7                                       & \textless Los+Angeles\textgreater\textless love\textgreater\textless \textit{Pacific+Time}\textgreater                                & (33.78, 118.29)                                                                               \\ \hline
				\end{tabular}
				\caption{Beispiel Schritte Vorverarbeitung + Zerlegung + Zeitzone hinzufügen}
				\end{table}

			Für jeden Tweet in den Trainingsdatensätzen wird eine solche Verarbeitung durchgeführt.
			Es liegt nun also eine Menge an Referenzwerten mit zugehörigen geografischen Koordinaten vor die angeben wo dieser Referenzwert erfasst wurde.

			Um die Vorkommen quantitativ zu erfassen sollen die Tupel aus Referenzwert und geografischer Position verglichen werden.
			Für jedes Tupel wird in der vorgestellten Struktur der Georeferenz-Basis (siehe Tabelle \ref{tab:strukturMitHierarchie1}) ein Datensatz angelegt und mit einem Wert von 1 für die absolute Häufigkeit initialsiert. 
			Stimmt sowohl der Referenzwert als auch die geografische Position mit einem vorhandenen Datensatz überein soll die absolute Häufigkeit für dieses Tupel inkrementiert werden.
			In dieser Art werden alle erzeugten Referenzwerte und geografischen Postionen verglichen und die Vorkommen erfasst.

			Die geografischen Koordinaten eines Tweets sind für diese Art der quantitativen Erfassung allerdings zu genau. 
			Diese werden zumeist mit Hilfe von GPS-Modulen mobiler Endgeräte wie Smartphones erfasst und geben eine Position oft auf wenige Meter genau an.
			...
			Damit wird zum einen die geografische Position vergleichbar, und zum anderen bildet dies den Einstieg in die in Kapitel \ref{chp:Grundlagen} eingeführte geografische Hierarchie.

			\subsubsection{Bestimmung der nächstgelegenen Stadt mit Hilfe von Voronoi-Regionen} 
				...
				In jeder dieser Region liegt exakt ein Punkt.  
				...
				Durch die Teilmengenbeziehung ist es nun nicht mehr nötig die geografischen Regionen der anderen Hierarchieebenen zu bestimmen diese werden mit der Stadt implizit mitbestimmt.
		...
		\subsection{Zusammenfassung Verfahren zum Einlernen der Georeferenz-Basis} 
