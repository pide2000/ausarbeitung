...
\chapter{Lösungsansatz} \label{chp:Loesungsansatz}
	...
	\section{Verfahren zum Einlernen der Georeferenz-Basis} \label{sec:VefrahrenZumEinlernen} 	
		...
		\subsection{Eliminierung von Mehr- und Doppeldeutigkeiten} \label{sub:VorvNutzerZeitzone} 
	...
	\section{Geolokalisierung: Auflösen des Nutzer-Standortes mit Hilfe der Georeferenz-Basis} \label{sec:AufloesenDesNutzerStandortes} 
		...
		Es werden dazu die Schritte aus den Abschnitten \ref{sub:Vorv}, \ref{sub:VorvNGramme} und \ref{sub:VorvNutzerZeitzone} durchgeführt (Vorverarbeitung).
		...
		Das Ziel des Analyse-Schrittes ist es, die Georeferenz zu ermitteln.
		...
		Im folgenden wird lediglich der Analyse-Schritt betrachtet. 
		Als Eingabe werden die Ergebnisse der Abfrage der potenziellen geografischen Indikatoren an die Georeferenz-Basis verwendet. 
		...
		\subsection{Analyse basierend auf absoluten Häufigkeiten} 
			...
			Diese sagen aus, wie oft ein Referenzwert an einer geografischen Position, in der Vornoi-Region einer Stadt, aufgetreten ist (siehe Abschnitt \ref{sub:absHaufBestimmen}). 
			...
			Es ist anzunehmen, dass in der Voronoi-Region einer Stadt der Name der zugehörigen Stadt häufig vorkommt.
			Dadurch kann eine Relevanz des Referenzwertes zu einer Stadt abgeleitet werden. 
			Ist die absolute Häufigkeit für einen Referenzwert gering, so ist er von nur wenigen Nutzern als Nutzer-Standort in einer Voronoi-Region angegeben worden, und somit weniger relevant.
		...
		\subsection{Probleme bei der ausschließlichen Betrachtung der absoluten Häufigkeiten} 
			...
			Der Referenzwert "'La Plata"' hat offensichtlich geografischen Bezug zur Stadt La Plata.
			"'La Plata"' tritt tatsächlich in der Voronoi-Region der Stadt La Plata in Argentinien 91 mal auf.			 
			Der Schwellwert könnte nun aufgrund der Erfahrung mit dem Referenzwert "'La Plata"' auf 90 angesetzt werden.

			Der Referenzwert "'the"' hat offensichtlich keinen geografischen Bezug.
			Trotzdem tritt der Wert 91 mal in der Stadt Jakarta auf.
			Mit einem Schwellwert von 90 für die absolute Häufigkeit würde dem Referenzwert "'the"' ein geografischer Bezug zugeordnet werden.
		...
		\subsection{Einführung von Schwellwerten für die absolute und relative Häufigkeit}  
