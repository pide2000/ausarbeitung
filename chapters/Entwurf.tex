...
\chapter{Lösungsansatz} \label{chp:Loesungsansatz}
	...
	\section{Verfahren zum Einlernen der Georeferenz-Basis} \label{sec:VefrahrenZumEinlernen} 	
		...
		\subsection{Zerlegung der Werte im Nutzer-Standortfeld zur Extrahierung von Informationen} 

				Die Zerlegung der Werte soll es ermöglichen Informationen aus dem Nutzer-Standortfeld zu extrahieren.
				Die Zerlegung soll mit Hilfe sogenannter N-Gramme erfolgen.

				\subsubsection{N-Gramme}

				\subsubsection{Vorteile bei der Zerlegung durch N-Gramme}   


				\begin{table}[h]
				\centering
				\caption{tab:NGramme}
				\label{Zerlegung in N-Gramme}
				\begin{tabular}{|l|l|l|}
				\hline 
