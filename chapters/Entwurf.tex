...
\section{Indikatoren zur Bestimmung der geografischen Lokation}
	...
	\todo{Wie detailliert hier auf Framework eingehen? Präprozessor-Konzept zur universellen Vorverarbeitung}
	...
	\subsection{Vorverarbeitung der Indikatoren (Präprozessor-Konzept)}
		\begin{enumerate}
			...
			\item \todo{NGram ist zerntrales Element! extra subsection?} Ngram Erzeugung
			\item \todo{Checken wie oft das vorkommt und wie groß der Nutzen ist} Zeitzone als \"schärfenden Indikator für doppeldeutige Namen\". Beispiel für Einbeziehung weiterer Indikatoren -> universeller Einsatz. 
		\end{enumerate}
