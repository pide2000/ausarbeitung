...
\chapter{Lösungsansatz} \label{chp:Loesungsansatz}
	...
	\section{Verfahren zum einlernen geografischer Indikatoren am Beispiel von Twitter} 
		...
		Um dies zu umgehen sollen die verwendeten Datenwerte aus dem Nutzer-Standort automatisch eingelernt werden.
		Es soll hier eine Georeferenz-Basis erzeugt werden, welche es ermöglicht den genutzten Datenwerten im Nutzer-Standort eine Georeferenz zuzuweisen. 
		...
		Es können dadurch domänenspezifische Eigenheiten bei der Verwendung von Toponymen berücksichtigt werden. 
		Auch domäneninterne Begriffe sollen hierdurch gelernt werden können.

		In einem ersten Unterkapitel soll der Ablauf und die nötigen Daten zur Umsetzung eines solchen Lernverfahrens erläutert werden.
