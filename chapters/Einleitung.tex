...
\chapter{Einleitung}\label{chp:Einleitung}
	...
	\section{Motivation und Hintergründe}
		...
		In den 140 Zeichen des Tweet-Textes teilen Twitter-Nutzer Informationen unterschiedlicher Ausprägung mit.
		Unter anderem wird über privates, Sportergebnisse, Großereignisse, persönliche Erfahrungen und persönliche Meinungen berichtet. 
		Auch Bilder und Links können in einem Tweet-Text enthalten sein. 
	...
	\section{Problembeschreibung} 
		Um gewinnbringende Informationen aus den Tweets erzeugen zu können, ist es wichtig möglichst vielen Tweets eine Georeferenz zuordenen zu können.
	...
	Die folgenden Anforderungen sollen von der erarbeiteten Lösung erfüllt werden.
		\begin{enumerate}
			...
			\item[R3] Das Ergebniss ist eine Georeferenz, dabei soll vom Anwender individuell zwischen folgenden Hierarchieebenen frei gewählt werden können (R3): 
			\begin{enumerate}
