...
\newpage
	...
	\section{Geografische Grundlagen und Begriffe}
		...
		\subsection{Toponyme in geografischen Indikatoren} \label{sec:ToponymeInGeografischenIndikatoren}
			...
			Ein Problem kann allerdings darstellen, dass Toponyme nicht standardisiert sind.
			Im folgenden werden die Probleme genauer betrachtet.

			\subsubsection{Alternative Toponyme}
				...
				Ein Beispiel für alternative Toponyme sind Bei- und Spitznamen für Städte.
